  ...
  return (
    <div className="bg-gray-800/90 backdrop-blur-sm border border-cyan-400/30 rounded-2xl p-6 mb-4">
      ...
      {uploadedFiles.length > 0 && (
        <div className="mt-6">
          <h4 className="text-sm font-semibold text-gray-300 mb-3 font-mono">
            Uploaded Files:
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {uploadedFiles.map((file) => (
              <div
                key={file.id}
                className="flex items-center space-x-3 p-3 bg-gray-900/50 border border-gray-600/50 rounded-lg"
              >
